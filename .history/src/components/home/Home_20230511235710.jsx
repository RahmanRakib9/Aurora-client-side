...
const Home = () => {
  ...
  <div className="col-span-8 md:col-span-6 bg-gray-200 p-4">
    <!-- This div takes up 8 columns on small screens, and 6 columns on medium screens and above -->
  </div>
  <div className="col-span-8 md:col-span-2 bg-gray-400 p-4">
    <!-- This div takes up 8 columns on small screens, and 2 columns on medium screens and above -->
  </div>
